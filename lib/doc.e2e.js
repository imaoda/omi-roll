...
function _buildDoc() {
  _buildDoc = _asyncToGenerator(function*(cwd) {
    const umiLibPath = (0, _path.join)(__dirname, "../bin/roll.js");
...
test(
  ...
  _asyncToGenerator(function*() {
    ...
    const buttonCls = yield page.evaluate(() =>
...
test(
  ...
  _asyncToGenerator(function*() {
    ...
    const favicon = yield page.evaluate(
...
test(
  "babel-extra-babel-presets-and-plugins",
  /*#__PURE__*/
  _asyncToGenerator(function*() {
    yield page.goto(
      `http://localhost:${servers["babel-extra-babel-presets-and-plugins"].port}/`,
      {
        waitUntil: "networkidle2",
      }
    );
